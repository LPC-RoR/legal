class Tarifas::TarTipoVariablesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Porcentaje variable del tipo de causa exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(objeto_params)
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Porcentaje variable del tipo de causa exitosamente actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @rdrccn, notice: "Porcentaje variable del tipo de causa exitosamente eliminado." }
  ...
  private
    ...
    def objeto_params
      params.require(:tar_tipo_variable).permit(:tar_tarifa_id, :variable_tipo_causa, :code_causa)
    end
end
