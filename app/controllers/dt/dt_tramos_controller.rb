class Dt::DtTramosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Tramo de multas fue exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(dt_tramo_params)
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Tramo de multas fue exitosamente actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @rdrccn, notice: "Tramo de multas fue exitosamente eliminado." }
