class Modelos::MConceptosController < ApplicationController
  ...
  # GET /m_conceptos/new
  def new
    modelo = MModelo.find(params[:oid])
    @objeto = MConcepto.new(m_modelo_id: params[:oid], orden: modelo.m_conceptos.count + 1)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Concepto fue exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(m_concepto_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Concepto fue exitosamente actualizado." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Concepto fue exitosamente eliminado." }
