class Modelos::MItemsController < ApplicationController
  ...
  def show
    ...
    set_tabla('item-m_registros', @objeto.m_registros.where(m_periodo_id: params[:oid]).order(:orden), false)
    set_tabla('periodo-m_registros', periodo.m_registros.where(m_item_id: nil).order(:orden), false)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Item fue exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(m_item_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Item fue exitosamente actualizado." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Item fue exitosamente eliminado." }
  ...
  private
    ...
    def m_item_params
      params.require(:m_item).permit(:orden, :m_item, :m_concepto_id, :presupuesto, :abono_cargo)
    end
end
