class Modelos::MDatosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Dato fue exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(m_dato_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Dato fue exitosamente actualizado." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Dato fue exitosamente eliminado." }
