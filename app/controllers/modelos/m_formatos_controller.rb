...
#    owner = MBanco.find(params[:m_banco_id])
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "M formato was successfully created." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(m_formato_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "M formato was successfully updated." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "M formato was successfully destroyed." }
