class Actividades::AgeLogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Modificación de la actividad fue exitosamente creada." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(age_log_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Modificación de la actividad fue exitosamente actualizada." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Modificación de la actividad fue exitosamente eliminada." }
