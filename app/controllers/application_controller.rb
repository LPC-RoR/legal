class ApplicationController < ActionController::Base
	...
	# Seguridad
	helper_method :version_activa, :dog_name, :dog_email, :nomina_activa, :perfil_activo?, :perfil_activo, :dog?, :admin?, :usuario?, :nomina?, :publico?, :seguridad, :public_controllers, :check_tipo_usuario
	...
	helper_method :cfg_defaults, :cfg_navbar, :cfg_color
