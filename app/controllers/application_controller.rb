...
#	helper PdfHelper
  ...
  def pundit_user
	...
	helper_method :vlr_uf, :uf_fecha, :enlaces_general, :v_enlaces_general, :enlaces_perfil, :v_enlaces_perfil, :v_enlaces, :set_st_estado
	...
	helper_method :cntxt_bck_rdrctn, :shw_cnt_tab_indx, :shw_dnnc_tab_indx
