class Recursos::RcrsLogosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Logo fue exitósamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(rcrs_logo_params)
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Logo fue exitósamente actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @rdrccn, status: :see_other, notice: "Logo fue exitósamente eliminado." }
