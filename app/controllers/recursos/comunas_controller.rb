class Recursos::ComunasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Comuna fue exitosamente creada." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(comuna_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Comuna fue exitosamente actualizada." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Comuna fue exitosamente eliminada." }
