class Csc::DemandantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Demandante fue exitosamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(demandante_params)
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Demandante fue exitosamente actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @rdrccn, notice: "Demandante fue exitosamente eliminado." }
