class Karin::KrnTestigosController < ApplicationController
  ...
  private
    ...
    def krn_testigo_params
      params.require(:krn_testigo).permit(:krn_denuncia_id, :ownr_type, :ownr_id, :empleado_externo, :krn_empresa_externa_id, :rut, 
        :nombre, :cargo, :lugar_trabajo, :email, :email_ok, :articulo_4_1, :articulo_516, :direccion_notificacion, :telefono, :origen, :dclrcn_intrrmpd)
    end
end
