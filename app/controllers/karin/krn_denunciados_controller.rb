class Karin::KrnDenunciadosController < ApplicationController
  ...
  before_action :set_krn_denunciado, only: %i[ show edit update destroy cargar_pdf swtch rlzd set_fld ]
  ...
  private
    ...
    def krn_denunciado_params 
      params.require(:krn_denunciado).permit(:krn_denuncia_id, :krn_empresa_externa_id, :rut, :nombre, :cargo, :lugar_trabajo, :email, 
        :email_ok, :articulo_4_1, :articulo_516, :direccion_notificacion, :empleado_externo, :relacion_denunciante, :telefono, :dclrcn_intrrmpd)
    end
end
