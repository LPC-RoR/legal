class Karin::KrnDenunciadosController < ApplicationController
  ...
  private
    ...
    def krn_denunciado_params 
      params.require(:krn_denunciado).permit(:krn_denuncia_id, :krn_empresa_externa_id, :rut, :nombre, :cargo, :lugar_trabajo, :email, :email_ok, :articulo_4_1, :articulo_516, :direccion_notificacion, :empleado_externo, :relacion_denunciante, :telefono)
    end
end
