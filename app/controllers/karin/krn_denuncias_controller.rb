class Karin::KrnDenunciasController < ApplicationController
  ...
  before_action :set_krn_denuncia, only: %i[ show edit update destroy cargar_pdf combinar_pdf cambiar_etapa preparar_txt_anonimizado anonimizar_expediente swtch niler rlzd pdf_combinado pdf_designacion pdf_notificaciones pdf_declaraciones pdf_pruebas annmzr set_fld prg krn_pdf_rprt ]
