class Lgl::LglPuntosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Punto fue exitósamente creado." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(lgl_punto_params)
        get_rdrccn
        format.html { redirect_to @rdrccn, notice: "Punto fue exitósamente actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @rdrccn, notice: "Punto fue exitósamente eliminado." }
