class ClssTtlPltfrm < ApplicationRecord
  ...
  def self.lyt
    {
      indx: {
        clss_str: "pltfrm-titulo-borde rounded-3 p-1 app_lnk responsive-ttl",
      ...
      indx_md: {
        clss_str: "pltfrm-titulo-borde-md rounded-2 app_lnk responsive-ttl",
      ...
      indx_compact: {
        clss_str: "pltfrm-titulo-borde rounded-2 app_lnk responsive-ttl",
