...
#        { tipo: 'txt_dclrcn',           si: ->(o) { o.dnnc.invstgdr_ok? } }
  ...
  def self.act_nombre
    {
          ...
          'tsk_notificar_dnnc'        => 'Notificar a los participantes la recepción de la denuncia',
  ...
  def self.act_lst?(act)
    ['antecedentes', 'mdds_rsgrd', 'medidas_resguardo', 'objecion_antcdnts', 'medidas_sanciones', 'apt'].include?(act)
  end
