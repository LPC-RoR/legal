...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference("Estado.count") do
      post estados_url, params: { estado: { causa_id: @estado.causa_id, estado: @estado.estado, link: @estado.link, urgente: @estado.urgente } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { causa_id: @estado.causa_id, estado: @estado.estado, link: @estado.link, urgente: @estado.urgente } }
