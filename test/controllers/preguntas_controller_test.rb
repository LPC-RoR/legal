...
class PreguntasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pregunta" do
    assert_difference("Pregunta.count") do
      post preguntas_url, params: { pregunta: { orden: @pregunta.orden, pregunta: @pregunta.pregunta, referencia: @pregunta.referencia, tipo: @pregunta.tipo } }
    end
  ...
  test "should update pregunta" do
    patch pregunta_url(@pregunta), params: { pregunta: { orden: @pregunta.orden, pregunta: @pregunta.pregunta, referencia: @pregunta.referencia, tipo: @pregunta.tipo } }
