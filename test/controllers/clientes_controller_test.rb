...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { razon_social: @cliente.razon_social, rut: @cliente.rut } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { razon_social: @cliente.razon_social, rut: @cliente.rut } }
