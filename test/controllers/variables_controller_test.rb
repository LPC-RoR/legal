...
class VariablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post variables_url, params: { variable: { tipo: @variable.tipo, variable: @variable.variable } }
    end
  ...
  test "should update variable" do
    patch variable_url(@variable), params: { variable: { tipo: @variable.tipo, variable: @variable.variable } }
