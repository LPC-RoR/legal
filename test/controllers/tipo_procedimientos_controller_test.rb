...
class TipoProcedimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_procedimiento" do
    assert_difference("TipoProcedimiento.count") do
      post tipo_procedimientos_url, params: { tipo_procedimiento: { tipo_procedimiento: @tipo_procedimiento.tipo_procedimiento } }
    end
  ...
  test "should update tipo_procedimiento" do
    patch tipo_procedimiento_url(@tipo_procedimiento), params: { tipo_procedimiento: { tipo_procedimiento: @tipo_procedimiento.tipo_procedimiento } }
