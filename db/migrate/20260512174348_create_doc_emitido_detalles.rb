class CreateDocEmitidoDetalles < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :doc_emitido_detalles, [:doc_emitido_id, :item], unique: true, name: 'index_doc_emitido_detalles_on_doc_item'
  end
end
