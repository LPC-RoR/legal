...
ActiveRecord::Schema[8.0].define(version: 2026_06_24_154835) do
  ...
  create_table "causas", force: :cascade do |t|
    ...
    t.index ["estado_financiero"], name: "index_causas_on_estado_financiero"
    t.index ["estado_operativo"], name: "index_causas_on_estado_operativo"
  ...
  create_table "check_realizados", force: :cascade do |t|
    ...
    t.index ["excluir"], name: "index_check_realizados_on_excluir"
  ...
  create_table "krn_denuncias", force: :cascade do |t|
    ...
    t.boolean "objcn_invstgdr"
    t.boolean "evlcn_incmplt"
    t.boolean "evlcn_incnsstnt"
    t.boolean "evlcn_ok"
    t.datetime "plz_prnncmnt_vncd"
    t.boolean "prnncmnt_vncd"
    t.boolean "investigacion_externa"
    t.datetime "fecha_rcpcn_infrm"
    t.boolean "crr_dnnc"
    t.datetime "fecha_dvlcn"
    t.string "identificador"
    t.boolean "objcn_acogida"
  ...
  create_table "responsable_actividades", force: :cascade do |t|
    t.bigint "age_actividad_id", null: false
    t.bigint "usuario_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["age_actividad_id"], name: "index_responsable_actividades_on_age_actividad_id"
    t.index ["usuario_id"], name: "index_responsable_actividades_on_usuario_id"
  end
  ...
  create_table "tar_facturaciones", force: :cascade do |t|
    ...
    t.index ["facturado"], name: "index_tar_facturaciones_on_facturado"
